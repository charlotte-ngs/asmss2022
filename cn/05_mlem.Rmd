...
The objective is to predict breeding values for sires $1$, $3$ and $4$ based on the above dataset. The following values for the variance components are assumed: $\sigma_s^2 = 5$ and $\sigma_e^2 = 55$
