...
## Pedigree BLUP
In real datasets, the assumption of unrelated sires is unrealistic, because the selection process favors that male offspring of a given sire will be selected as sires again. As a consequence of this the random sire effects are not independent. The dependence structure between the sire effects must be considered in the analysis. 
