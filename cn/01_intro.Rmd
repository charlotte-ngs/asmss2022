...
2. The EU-Interreg project "[SESAM](https://www.alpine-space.eu/projects/sesam/en/home)" aimed at predicting basic behavior traits from data obtained from sensors and from video recordings.
