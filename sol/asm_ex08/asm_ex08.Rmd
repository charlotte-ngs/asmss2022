...
The results of the `aov()` analysis gives estimates for the residual error variance $\sigma_e^2$ and for the variance $\sigma_a^2$ within the repeated measurements of one animal. The estimate $\widehat{\sigma_e^2}$ is directly obtained from the section `Error: Within` in the column `Mean Sq`. 
